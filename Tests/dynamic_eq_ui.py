...
def test_v106_shared_four_band_modules_and_deess_presets():
    ...
    assert "VVCHAIN v1.0.29" in web
    assert "VVCHAIN v1.0.29" in editor
...
def main():
    ...
    print("PASS: 50x v1.0.29 compact EQ/DYN EQ readout identity + format checks")
    print("PASS: v1.0.29 Q wheel 3x continuous / shared-path check")

...
private:
    ...
    std::unique_ptr<juce::ToggleButton> topMasterBypassButton;
    std::unique_ptr<BoolAttachment> topMasterBypassAttachment;
    std::unique_ptr<juce::ToggleButton> mixBypassButton;
